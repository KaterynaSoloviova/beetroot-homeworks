...
# Write a program that counts lines and characters in a file (similar to `wc` Unix-utility, for additional info about
# it follow the link or in case you have macOS or Linux - just call manual for this utility via command: man wc).
#
...
# ambitious, you may be able to improve this by passing an open file object into the two count functions (hint:
# file.seek(0) is a file rewind).

from mymod import test2, test
